...
function NodeActionService(config) {
    ...
    function doInit(message) {
        ...
        return userCodeRunner.init(message).then(function (result) {
            ...
            DEBUG.functionEnd("userCodeRunner.init() Success");
            return true;
        }).catch(function (error) {
            ...
            writeMarkers();
            DEBUG.functionEnd("userCodeRunner.init() Error: " + error);
    ...
    function doRun(req) {
        ...
        return userCodeRunner.run(msg.value).then(function(result) {
            ...
            writeMarkers();
            DEBUG.functionEnd("userCodeRunner.run(): Success (" + result + ")");
            return result;
        }).catch(function (error) {
            console.error(error);
            writeMarkers();
            DEBUG.functionEnd("userCodeRunner.run(): Error:" + error );
            return Promise.reject(error);
        });
    }
